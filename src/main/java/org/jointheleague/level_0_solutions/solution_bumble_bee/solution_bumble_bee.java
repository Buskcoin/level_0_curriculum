...
/*make sure kids understand modulo at the end of this exercise. */


void draw() {
  /*Use A loop to make a body for the Bee! Then put his head on using drawBeeFace(x,y)*/


  for (int i = 0; i < 435; i=i+13) {
    if (i%2==0) {
      fill(255, 251, 28);
    } else {
      fill(0, 0, 0);
