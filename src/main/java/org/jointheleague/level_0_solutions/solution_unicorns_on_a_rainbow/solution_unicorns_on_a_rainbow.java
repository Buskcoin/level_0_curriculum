...
void draw() {
  // 6. Draw the unicorn using: image(String imageName, int xPosition, int yPosition)
  image(unicorn, mouseX, mouseY);
  // 7. Change the line above so that the unicorn moves with the mouse.
  // 8. You may want to make your unicorn transparent. See these instructions: 
  // 9. When the mouse is pressed, redraw the rainbow background
  if (mousePressed)
    background(rainbow);
}
