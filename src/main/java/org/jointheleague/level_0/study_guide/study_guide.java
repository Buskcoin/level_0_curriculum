...
/**
 Give to kids 1 or 2 weeks before exam									
...
for ( int i = 0; i<10; i++){
 ...
 int i = 0;   This is the starting point of the loop. You must declare the int.
 i<10; This is the finishing point for the loop. The loop will continue as long as i is less than 10.
...
Don’t forget the null, or that any text needs to be in quotes.
...
Methods
You must have a main method in order to start your class running.
...
void This tells you what the method will return - in this case nothing.
drawSquare  This is the name of the method, that you use to call it.
...
In this case it is expecting an int, so you need you provide an int when you call the method and it is going to a return an int so you need to create an int to put it in, like this
...
The value of 11%5 is 1, because 5 goes into 11, 2 times (=10) with a remainder of 1.
